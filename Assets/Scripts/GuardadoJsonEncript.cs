...
public class GuardadoJsonEncript : MonoBehaviour
{
    ...
    public GameObject puntoshud;
    public GameObject namehud;
    ...
    public class SaveData
    {
        ...
        public SaveData(string _name, int _puntuacion)
        {
    ...
    void Update()
    {
        ...
        {
            puntuacion = puntoshud.GetComponent<guardarpuntuacion>().puntuacion;
            
            
            
            //Instanciamos la clase anidada pasándole por parámetro las variables que queremos guardar
            SaveData sd = new SaveData(name, puntuacion);
        ...
        {
            puntoshud.GetComponent<guardarpuntuacion>().puntuacion=puntuacion;
            ...
            //maxHp = sd.maxHp;
            //dinero = sd.dinero;
            //marcaCoche = sd.marcaCoche;
            //numeroFavorito = sd.numeroFavorito;
            puntuacion=sd.puntuacion;
